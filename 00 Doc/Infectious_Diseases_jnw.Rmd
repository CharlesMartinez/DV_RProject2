...
```{r, echo = TRUE}
source("../02 Data Wrangling/Data_Wrangle1_jnw.R")
```
This plot looks at only the STI's chlamydia, gonorrhea, and HIV, for the years 2001-2014. There are two separate plots for males and females, and all of the counties in California are included.
